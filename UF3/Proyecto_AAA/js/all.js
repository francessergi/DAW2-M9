...
$('.owl-watch').owlCarousel({
    ...
    navText: [
        "<div class='fa fa-angle-left effect-1'></div>",
        "<div class='fa fa-angle-right effect-1'></div>"
    ],
    responsive: {
        0: {
            nav: false,
        ...
        render: function(b) {
            ...
            var e = this.$element.find("option").map(function() {
                    if (this.selected) {
                        ...
                        var e, b = a(this),
                            d = b.data("icon") && c.options.showIcon ? '<div class="' + c.options.iconBase + " " + b.data("icon") + '"></div> ' : "";
